// ============================================================================
// app.js
// Punto de entrada del prototipo. Conecta el motor (ya validado, sin
// cambios de lógica salvo la extensión puntual documentada en filters.js)
// con la capa de interfaz: consulta, contexto, gráfico, respuesta,
// comparación e historial.
//
// PROTOTIPO DE EXPERIENCIA, NO DE ESTÉTICA -- ver css/global.css.
// ============================================================================

// ============================================================================
// app-prueba-10dias.js
// PRUEBA METODOLÓGICA REVERSIBLE -- copia de app.js con un único cambio: la
// instancia de estado usa buildVentanas10Dias() (stats-ventanas-10dias.js)
// en vez de las ventanas de 5 días vigentes (buildFixedWindows()). No es la
// fuente de verdad del producto -- ver explorar-prueba-10dias.html.
//
// Todo lo demás es exactamente app.js: mismo motor (filters.js/stats.js vía
// state.js, ahora parametrizado con windowBuilder), mismo query-builder.js,
// mismo charts.js, mismo history.js/comparison.js. La orquestación de UI se
// duplicó (es específica de cada página, mismo criterio ya usado entre
// Explorar/Comparar/Escenarios) -- lo que NO se duplicó es ningún cálculo:
// percentiles, clasificación, KPIs y mensajes siguen viniendo del mismo
// stats.js sin tocar.
// ============================================================================
...
const state = createAppState({ windowBuilder: buildVentanas10Dias }); // única diferencia real con app.js
