// ============================================================================
// comparar-app.js
// Punto de entrada de COMPARAR. Mismo patrón que app.js/escenario-app.js:
// un único render() que redibuja todo tras cada cambio de estado.
//
...
// 5 días originales (ver test/comparacion-ventanas-5-vs-10-dias.mjs).
// comparison-state.js sigue parametrizado con windowBuilder (por defecto
// buildFixedWindows, 5 días) -- acá se pasa explícitamente
// buildVentanas10Dias como la fuente de verdad vigente.
//
// Reutiliza SIN modificar: comparison-state.js (motor), query-builder.js,
// history.js.
// ============================================================================
...
const state = createComparisonState({ windowBuilder: buildVentanas10Dias });
