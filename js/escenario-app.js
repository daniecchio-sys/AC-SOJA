// ============================================================================
// escenario-app.js
// Punto de entrada de ESCENARIOS -- MVP funcional completo, arquitectura v2
// (AC_SOJA_25_26_Arquitectura_Funcional_Escenarios_v2.md). Mismo patrón que
// app.js/comparar-app.js: un único render() que redibuja todo tras cada
// cambio de estado.
//
// Ventanas de fecha de siembra: ~10 días (buildVentanas10Dias()), adoptadas
// como configuración definitiva tras la comparación reversible contra las
// 5 días originales (ver test/comparacion-escenarios-5-vs-10-dias.mjs). El
// heatmap muestra siempre las 11 ventanas completas, sin deslizador de
// rango (con 21 ventanas hacía falta recortar la vista por defecto; con 11
// entra todo sin scroll). escenario-state.js sigue parametrizado con
// windowBuilder (por defecto buildFixedWindows, 5 días) -- acá se pasa
// explícitamente buildVentanas10Dias como la fuente de verdad vigente.
//
...
// El rango de fecha visible del heatmap no existe en este módulo: con 11
